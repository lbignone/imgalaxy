...
\title{
    Automatic image segmentation of galaxy and strong gravitational lenses with deep learning
}
...
\author{
    J. Castagnino\inst{1}, L. A. Bignone\inst{2}, S. E. Pedrosa\inst{2}, M. Makler\inst{3} \& J. P. França\inst{4}
}
