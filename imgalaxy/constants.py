...
RUN_FROM = 'local'
NUM_EPOCHS = 150
SIZE = 128  # Size of resized images and masks. You may have to change batch sizes.
MASK = 'spiral_mask'
TRAIN_WITH = 'all'  # "all": all imgs in training dataset. "only" for spiraled galaxies
